...
def showWindow():
    ...
    roots.title('GateKeyPer') # This renames the title of said window to 'signup'
    ...
    headingL = Label(roots, text='\nWelcome to GateKeyPer. We need you to enter a global password which will be asked each time you want to view stored passwords.\n',justify='left',wraplength=300) # This just does the same as above, instead with the text new username.
...
def showSignature():
    text = 'This project is made under the guidance of Mr. Anurag Gupta by Rahul Raj Tripathi.'
    return text
